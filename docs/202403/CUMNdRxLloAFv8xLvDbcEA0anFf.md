# 全流程：使用影刀RPA实现自动化数据采集，heygen注册、内容生产、数字人制作与平台分发

> 来源：[https://ia0969wpr2.feishu.cn/docx/CUMNdRxLloAFv8xLvDbcEA0anFf](https://ia0969wpr2.feishu.cn/docx/CUMNdRxLloAFv8xLvDbcEA0anFf)
...
![](img/d80919a0e00a6eab62c7687bbc7a96fb.png)
...
![](img/a147728e32cd4df8648ebe4237433ea2.png)
...
![](img/6662c646e934eb8bc47fe1a97d2d302c.png)
...
*   根据链接或上面采集的笔记获取小红书详情，点赞评藏、文案等数据和图片等无水印下载

#### 演示

#### 最终数据如下，包括笔记数据、以及图片/视频无水印下载：

![](img/ba1aadb755df1cb2eddb4d52fab7d7db.png)

![](img/348192a81c6c3cec20fefa2693074540.png)

![](img/1964cf1ede7da20d5dd6c707e9743249.png)
...
*   根据关键词/博主/博主点赞采集推特的推文阅读数、点赞评藏等详细数据

#### 演示

采集后数据如下：

![](img/e441fa5ef5c66a31cc4f37934cfd072a.png)

#### 实现与源码

同上，在演示的最后有主要流程可以参考。和抖音小红书不同，对于推特这种页面元素经常变动不好定位的网站，如果使用RPA进行采集就只能采取这种方式了。

## 第二部分，使用影刀自动化注册heygen
...
![](img/d1b67929bccc5e4ca9a307b7990b6aa1.png)

如果我们没有域名，可以点击菜单栏中的第二个“Domain Registration”进行注册。拥有自己域名之后直接点击进入，然后点击左侧菜单中的Email

![](img/2ab2da6ff65db28efa005560130aa0b8.png)

点击开始使用

![](img/496b306a5ec48d8ab081cfae7a801377.png)
...
![](img/9088c8981185afde21c56d78f1e2effe.png)

点击创建并继续，借着点击“继续”

![](img/1a958b64b58b021b0ea7213373eba6c8.png)

走到下面这个页面的时候我们可以不用管这些配置，默认cf会帮我添加好的，我们点击“添加记录并启用”就可以了

![](img/05724b9e09bc6931c21d2d035e9bdf67.png)

等待DNS配置完成后，我们点击“路由规则”

![](img/94fb2524762654c57c98e9a996f5402a.png)

点击catch-all状态中的切换栏，改为开启状态

![](img/00aec0bbac7c576314b0397eaaf5cb98.png)

开启之后点击编辑

![](img/e01cd19579d30793694134da36f83bee.png)

这是我们选择我们刚刚设置的邮箱就可以了，这样，任何发送到*@example.com的邮件都会转发到你填写的目标邮箱里面，我们就可以通过影刀获取验证码了

![](img/ea68cf3805c2c55c1c501e1a4746c77e.png)

走到这一步我们就有了无限的邮箱了，下面就可以继续heygen的注册流程了

下面是整个的注册流程：

![](img/994c9c06a851bc893cea192ab2b721bd.png)
...
![](img/151f06579f32b8b6e25bc9176f5d2c1f.png)

当然这是一个非常简单的工作流，实际流程我们可以自定义，同时添加知识库、插件、外部接口等。

根据流程图我们首先新增一个LLM，根据用户输入生成口播文案

![](img/115aaaed15e0cb2c6bbf53cf7e0a3f0e.png)

然后对生成的口播文案进行标题、标签和推荐语生成

![](img/cf8afa8bf42647406b0e99d5691323ea.png)
...
![](img/0daf1cfb119f2c37bb39fa7f064a3dd3.png)
...
![](img/840e7d32f7e4cb70154bf95ea10802a1.png)

![](img/502244cebf8aac528b4e0229affda9dd.png)

![](img/0320ec81f85e05fa5575617a22abe048.png)
...
![](img/496ade5db8f74f7860a21b85a162657e.png)

小红书部分其实就是抓取小红书后我不习惯导出到Excel，因为不方便阅读，所以都是连同文案自动写入到Notion，方便我进行再次创作或者引用参考。

![](img/cd8c1d8cd6824c8ff29a0f5c88303561.png)
