...
> 来源：[https://eqsdsj0h4eo.feishu.cn/docx/AcpmddI2qogOBKx57vXc6JzMnJb](https://eqsdsj0h4eo.feishu.cn/docx/AcpmddI2qogOBKx57vXc6JzMnJb)
...
![](img/8b9f28f55838276b5ac879974af82748.png)

*   改进后的提问：“我近三天出现了发热、咳嗽和疲劳的症状，没有过敏史和慢性疾病。这些症状可能是什么原因导致的？”

![](img/86e6df7bac3303d338655b2eaf565dc6.png)
...
1.  明确指定角色：在提问时，清楚地指出你希望 ChatGPT 扮演的角色。

1.  提供角色背景：如果可能，提供一些关于该角色的背景信息，例如专业知识领域、工作经验等。

1.  调整问题风格：根据选定的角色，调整你的提问风格，以便更好地适应这一角色的回答方式。
...
![](img/660114e0a2f5172fddb87f91028d3169.png)

*   提问：“作为一名专注于 20 世纪欧洲历史的历史学家，请解释第一次世界大战的主要原因。”

![](img/829bfdbec1689348082ed301118800e4.png)

*   提问：“作为一名家庭医生，您如何评估和处理轻度头痛和疲劳的症状？”

*   提问：“作为一名具有 10 年临床经验的家庭医生，您如何评估和处理轻度头痛和疲劳的症状？”

*   提问：“作为一名编程教师，你能否为我推荐学习 Python 编程的资源？”

*   提问：“作为一名有 10 年经验的编程教师，你能否为初学者推荐学习 Python 编程的最佳实践和资源？”
...
1.  选择合适的分隔符：根据输入的内容和格式，选择恰当的分隔符，如三引号（```）、XML 标签、Markdown 标题等。

1.  明确标注各部分：使用分隔符前后清楚地标注各个部分的开始和结束，尤其是在文本较长或复杂时。

1.  提供说明：在使用分隔符时，如果可能的话，给出简短的说明或注释，指明每个部分的内容或目的。
...
1.  使用 XML 标签处理多项内容：用户需要对两篇文章进行总结和比较，可以使用 Markdown 标签作为分隔符：
...
1.  明确示例的范围：确保你的例子足够具体，以展示你的询问或指令的具体应用。

1.  使用分隔符标明示例：如果可能，使用适当的分隔符（如引号、括号等）清晰地标识示例的开始和结束。
...
![](img/c213f6a53aaa95affa9324463db006e8.png)
...
![](img/12c142165fa8e6695415ebea89913663.png)
...
1.  为每项活动设定可量化的目标，例如每天快走 30 分钟，每周至少做三次拉伸运动。

1.  确保目标适合中年男性程序员的实际情况，既挑战性又可实现。

1.  考虑用户的工作和生活习惯，确保健康计划与其日常生活相契合。

1.  为实现目标设定明确的时间限制，例如三个月内达到规定的运动频率和时长。
...
![](img/a7c7fcadeda2b144ec8d1ebc5fe8586b.png)
