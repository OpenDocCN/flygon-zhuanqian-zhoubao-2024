...
> 来源：[https://er7flrttos.feishu.cn/docx/ExTediltCoy3bIxvw3AcsrZLnyg](https://er7flrttos.feishu.cn/docx/ExTediltCoy3bIxvw3AcsrZLnyg)
...
![](img/acb78017c25b9b3280083c1079b53d08.png)

![](img/a8398da828e63a14e9cb4ddd0d120216.png)

![](img/bfbe39e395e60e6050f760a070b1ea38.png)
...
*   工薪阶层家庭长大的传统女孩，“别人家的孩子”，7年舞蹈基础

*   初三从班级倒数逆袭到班级前10；高中三年年级第一；本科四年专业第一（车辆工程），保研211；自考PMP证书；提前一年写完硕士毕业论文

*   一年时间减重30斤，体重保持中

*   现在车企国企的测试工程师，处于项目下游，工作内容是实车测试、编写用例、撰写专利，实车测试是可替换性超高的交付性工作。周围的同事大部分都加班，只有我到点拎包走。
...
*   离过年回家只有不到两周，下单的物料工作日才能到，再下一个周末就回家了，过完年回来也没人需要现场打印春联了吧？

*   平时有打印需求的人多吗？

*   就算他们需要打印，为什么来找我而不是街边的打印店？

*   打印春联赚回的钱能覆盖打印机和墨水成本吗？

*   前期没有经过调研，我怎么知道这些只爱买菜的老人们对这个穿脱袜神器感不感冒呢？
...
![](img/5d114ffa29d9ba96b993aab2504f03f4.png)

![](img/79d027072b27e581bce8399dcea8dbff.png)

![](img/aec1fd641749fa7de6ddb552c2115c1b.png)

![](img/ffe428b8a0d3b2d9c3746c84fe00b7b1.png)

![](img/30bf8ce753ac9735d5dcf75adb17a3ae.png)

![](img/795d6fab5449f9bcec0546ca6d380ee6.png)
...
![](img/78b53d462a472a251da646db9d33e7d3.png)
...
![](img/af508839f093561662dcb51db2e91233.png)
...
![](img/10e22fee4490b26ace56d3a45878180b.png)

![](img/2b2089965941c846f34a6739f1a3a415.png)

![](img/1d0cfa26d97fd56e1583c0c55ab08d3b.png)

![](img/8f8cedf898f9db5dc16bafbd94e412df.png)

![](img/f59b54d58464ff25c43b78993df835c8.png)

![](img/763afb483b18cd954b64211fb642a5a4.png)
...
*   如果很多爆款关于这部剧的冲突剧情都比较单一，那我就跟着剪固定的那几集

*   如果关于这部剧的爆款绝大部分是长视频，那我就把全剧浏览一遍，自己去找可以剪辑的地方

*   如果这部剧比较古早，那也没必要下载，优先选择日期新的短剧剪辑
...
1.  分割片段：前期使用的方法是识别字幕，根据对话起止时间来分割视频，后期节省时间可使用智能片段分割功能

1.  剪片头，加解说：编辑英文解说，保证解说时长在对应片段中且片段衔接流畅。将解说部分视频的音频分离，并静音或删除该段音频。

1.  字幕识别与导出：英文解说内容可以和中文对话一起进行识别，这是便于解说内容和对话内容的字体可以进行统一修改

1.  字幕翻译与导入：把翻译好的字幕重新导入剪映，确保没有遗漏后，可删除中文字幕

1.  字幕格式修改：调整字幕大小、字间距、行间距、位置，校对字幕是否超出屏幕范围

1.  定格：为了在片尾留下悬念，通常可以使用定格最后一幕的方式，同时添加一些音效

1.  遮盖中文字幕：蒙版功能只支持单个片段使用，所以可以新建复合片段时零碎的片段成为整体，便于添加蒙版。

![](img/b8ec6c38650634823b4e685e9b949be1.png)

### 中英文字幕同时识别

解说类视频，先把解说内容朗读出来，让英文解说和中文对话一起被识别，可以解决解说字幕和对话字幕大小不一的问题

![](img/479930f5102f93a3fc99c65c7d5135b3.png)

### 仔细校对

确认主轨片段不需要再进行其他更改后，再锁定文字，最后建立复合片段，进行蒙版遮挡中文字幕

![](img/bec3b564b62fd550857f23ba6eb1b0ea.png)

### 过剧情

拿到剧，先过剧情，并写下每一集讲的内容，除非很没有营养的集数可以略过。有条件的话，在过剧情的时候把前后呼应的集数做好备注。下面是我最近剪的几部剧的备注，还有一部剧的讲解文件被我清空回收站了

![](img/69dc0f9aa20d516971f8e76460549d2a.png)

![](img/65a8fc92445c842ed3f79ccdca6887da.png)

![](img/38950849330b31049b9dab9e88e3000b.png)
...
*   贴纸的大小，关键帧的定位、路线、覆盖长度等

*   画中画的数量、组合、透明度、位置等

*   主轨视频用智能镜头分割进行场景切片，便于片段的镜像以及片段之间的转场

*   字幕的大小、位置、样式（文字颜色、粗细，背景颜色、透明度、圆角、高矮宽窄等）

![](img/36f23a8f9bf9874894c00af695cfcfbb.png)

![](img/bdf3f6bfcd0d73abdec4de1843707a72.png)

![](img/e9d6c82f8c2c26732f150814fa932f9d.png)
...
1.  主副轨、转场、蒙版、抠图、关键帧、分割镜头、剪口播等功能的使用已经熟练

1.  副轨去重模板、主轨画面剪辑、旋转等操作对视频降重

1.  对好剧烂剧的甄别能力有所提升

1.  可以产出半解说、全消音类型的视频了，但是精剪能力还是要通过找对标和亲手剪辑来找网感
...
*   如果你只像一头老黄牛一样没有思考的坚持，那就是无用功

*   如果你只是动动嘴皮子，不动手做，那就是虚有其表
...
![](img/89729857dbf305610d7b736c8ffba973.png)

![](img/6f76c5850c28992293b13f2627a2c9b3.png)

教练没空回复消息的时候，其他船员的回复后续得到了领队@赫连雨彤 和教练的称赞；

感谢教练@Bridge @Raylen，感谢圈友们@悟道 @云端 @yhx @凉亭 @平凡 @乐善人生 @未闻 @梓佳的解答。

![](img/df2a8122d2534573753bf25a1ffea7ee.png)

![](img/e3ec121365256aec9ed83edf86149221.png)

![](img/6d867e141da221d8fcaa57bb68686810.png)

航海结束后志愿者@鸿鹏 邀请我进行经验分享，还基于亲身经验为我提出了宝贵的建议。

![](img/404945a1e8a10784281949f826d9e6a9.png)

![](img/9494c9bd61b2d8cca6a2a2d8499bd0eb.png)

![](img/c7b766bb47b0f265b627ecd92dfcc641.png)
...
# 高光时刻在这里：给“像我一样的新人”如何使用生财和航海的小tips
...
*   你打开手册，看一个字，就会自然地看到第二个字；

*   看一行，就会自然地看到第二行；

*   看一页，就会自然地看到下一页，然后慢慢往下看。
...
*   就像减肥一样，追求短期内快速掉秤只会导致最终暴饮暴食；

*   掌握减肥的底层逻辑，将运动和健康饮食融入生活，才能实现长期盈利。
