...
> 来源：[https://bnb422zi7t.feishu.cn/docx/NMdlddS0hoAAI4xBMLXcZyzFnGg](https://bnb422zi7t.feishu.cn/docx/NMdlddS0hoAAI4xBMLXcZyzFnGg)
...
![](img/771b5171175a6570886936276b5263b1.png)

![](img/01acaea986bc05f491dc2930b8a753f9.png)

![](img/8fea11b8d5e73099f7439b4a2a5bcf5c.png)

从写脚本--搭建广告账户--创造计划--文案--拍摄--视频剪辑--投放--视频过审--消耗转化整个流程都是我们部门负责。

平时的话会在后台上传剪辑好的广告素材。

![](img/7d1a664d00bf60e5fd89ae8de2f2956f.png)

然后选择在这些腾讯旗下的广告版位去投放。

![](img/ece7b5538dc16e70665fde2b2b0ec766.png)
...
![](img/7faf6e91569a27686fd91793c29714a0.png)

然后我每天上班第一件事都会打开看一下每天前十的素材参考

![](img/f29d7313fae93fb30da82f5bd57af71c.png)
...
![](img/f078ffc891ffe73e50f3cc2da2f79e14.png)
...
![](img/9158e043f3b1f47b8cce69ce6b27866f.png)

![](img/7febcae3b3a69ace1978e12520252b35.png)
...
![](img/eb50b70de13ebf815530c1d989635b3f.png)

# 成果展示

休了一个国庆假期回来，我发现的视频爆了！

![](img/5a9f0b1f3bd09270e10f38497a04db22.png)
...
![](img/3e1b688dfddd4decbd8bc75fbf33b290.png)

直到 14 号对业绩，运营无意中聊到，才知道那个视频已经跑了 30 万消耗了

![](img/c59afd197b094840011d4302ca7c664f.png)
...
![](img/512a887180e379a4260271e96f062720.png)

登录进去之后，我们能看到整个页面构成

![](img/cfbb494bb9c55866d658c3e8e0aa50dc.png)

然后左侧工具栏有个 AI 视频，后面有个数字人成片打开进去

![](img/4c5c6a9d8d27befdc6c09612318ce2e6.png)

根据自己的使用习惯去操作，我一般是先把写好的文案拷贝进去，千万别这样直接去选数字人和配音去生成，不然你会收获一个跟机关枪一样讲话的数字人。

需要点击如图一左下角的手动拆行编辑，如果手动编辑没亮就先点击帮我写脚本，再点击手动拆行编辑就可以了。

![](img/79639e7cb334ff943cc2dd5b2be98cf9.png)

![](img/74087a24fd4525d2ebac347984fa8878.png)
...
![](img/c353914e05007163e152e1a42cd025ce.png)

发亮的文字是中风险提示，建议修改的，根据自己的发布的平台和品去调整，这样编辑的时候就更方便了，避免违规、

![](img/1020ba77bb179478b2bdeb4b6ee8d8d9.png)
...
![](img/91f76864d21fcabe8c10d0d6018029ee.png)

背景可以选择系统推荐，不过系统推荐都是图片，我的素材可以上传图片和视频作为背景都可以，AI 生成就比较鸡肋了，也有可能我不会训练，对我来说目前系统推荐和自己的素材完全够用了。

![](img/621acd528270b56b326723fa89b33431.png)

最后就是配音了，根据数字人的形象选择合适配音，右侧倍速调节一般都是 1，偶尔可能我会调个 1.1，1.2 及以上太快了，不推荐。

![](img/99a48e6fd9ce5bcb0511ed2bc234f9a9.png)

完事后点击播放

![](img/ab442008d6cee9ca4e22ed33d742e939.png)

先渲染试听一下，试听没问题了

![](img/220cb6b5ddd1b81a330c297f516a8a59.png)

最后点右下角的立即生成就可以了，之后跳转到这个页面，根据视频时长生成的时间也不同，我基本一个 1-2 分钟的视频生成大概需要 3-5 分钟，几句话很快就出来了

![](img/d768f91fc31776f99374ea495f76b0fa.png)

这就是生成好的数字人视频

![](img/d37dd40be4eb8aca87cdf99046d4e8f3.png)

点进生成好的视频，可以先预览一下

![](img/c00f8c1b0969233414c2481add441793.png)

点击右侧的选择按钮

![](img/292903016b1a14d547fa3d6721ca9572.png)

下载到电脑文件夹就可以了

![](img/f1b743932c32898c0af7e1cd6062e2e6.png)

这样就生成了一个 AI 数字人的视频素材了

![](img/8c72992ac2c9d74b7b3d03073ed1917e.png)

最后再去根据品类去剪辑，我是对标爆款，所以基本是对帧剪辑，不过也是挺简单的

![](img/1701dacd56efbb38271b5307c3931daa.png)
...
1.  吸睛开头+数字人和产品上下分屏+产品介绍+背书+活动优惠
