# 器 | 学习/工作/创业/投资全域软件工具箱

> 来源：[https://o1xdfcjcp5c.feishu.cn/docx/Xfgkd9hjnoXOsoxAimFc9ZxCnGg](https://o1xdfcjcp5c.feishu.cn/docx/Xfgkd9hjnoXOsoxAimFc9ZxCnGg)
...
*   极速转化知识：任意网页/链接1分钟生成带动态PPT、动画及真人讲解的定制课程，支持中英文双语与20+人格化讲解风格（如暴躁老哥、爱因斯坦），适配“初学者-专家”全阶段学习需求。

*   深度互动提效：学习中随时提问，AI精准答疑；课后自动生成测试题并解析，形成“学-练-测”闭环，知识留存率提升60%。
...
*   产品经理重点关注Toolify.ai和Product Hunt，快速掌握市场趋势；

*   开发者必逛GitHub，开源项目能帮你省下80%开发时间；

*   投资人可以在这几个平台发现下一个AI独角兽。
...
*   研究者arXiv+Papers With Code→紧跟最前沿；所有人都可以逛AGI之路→查漏补缺。
...
![](img/b88ea6067ae1da6d37875b7b60a69a7f.png)
...
*   一站式解决团队需求：从日常沟通到深度协作，再到知识沉淀，飞书覆盖企业全流程需求，避免多工具割裂。

*   高效知识管理：知识库支持层级分类、标签管理、全局搜索，便于信息快速检索与复用，文档支持@提及、评论互动，实现“上下文关联”的知识沉淀。

*   创新功能提升效率：如“飞书妙记”可将会议录音自动转写为文字并生成摘要，大幅节省整理时间，多维表格等工具让非技术人员也能搭建轻量级业务系统。

*   适合多规模团队：免费版已能满足中小团队需求，企业版提供更强大的安全管控与定制化服务。

*   持续迭代与生态扩展：背靠字节跳动技术资源，飞书更新频率高，并集成第三方应用（如薪酬计算、CRM等）。
...
![](img/edfb25dc5bd89f85830ce0381545b9b1.png)
...
*   个人知识管理的标杆工具：专注个人知识沉淀，适合长期积累碎片化信息，形成可检索的知识体系。

*   无缝信息捕获能力：网页剪藏、微信文章保存、邮件转发至笔记等功能，解决“信息散落各处”的痛点。

*   高度灵活的组织方式：通过标签和笔记本的交叉管理，既能满足严谨分类，也能适应动态调整的需求。

*   持续迭代的核心功能：如“思维导图”整合、OCR识别升级、与第三方工具联动（如微信、钉钉、Google Drive）。

*   适用广泛人群：学生、研究者、职场人士均可通过模板和自定义功能，适配不同场景需求。

*   免费版基础功能齐全：个人用户免费版已支持基础同步与剪辑功能，高级版提供更大空间与高级功能（如PDF标注）。

官网（中国版）：https://www.yinxiang.com

国际版（Evernote）：https://www.evernote.com

![](img/c16e7b513b0f2811fdb2cc0f7b498e20.png)
...
*   All-in-One 的终极解决方案：替代多个单一工具（如Trello、Confluence、Airtable），降低工具切换成本，统一工作流。

*   高度自由与可扩展性：从个人日记到企业级知识库，均可通过模块化设计实现，适应性强，开发者友好，支持API和自定义集成，满足进阶需求。

*   知识互联与复用：数据库关联功能让信息不再是孤岛，例如将任务数据库与客户数据库联动，自动生成数据看板，全局搜索和页面链接功能，快速定位跨模块信息。

*   零成本启动，学习资源丰富：免费版支持基础功能，个人用户足以应对日常需求。官方教程、社区模板和第三方课程（如Notion Mastery）大幅降低学习门槛。

*   跨平台无缝体验：全平台覆盖，实时同步，支持离线编辑，适合分布式团队和远程办公。
...
*   一站式解决知识管理痛点：将碎片化信息（如微信文章、会议记录）统一存入知识库，通过AI关联与检索，避免多工具切换。

*   教育与职场场景深度适配：教师可上传学生档案生成个性化评语；职场人可快速分析财报、合同，效率提升数倍。

*   技术门槛低，免费高性能：无需自行部署大模型（如DeepSeek-R1需数百万硬件成本），直接享受腾讯提供的满血版服务。

*   细节优化提升体验：支持截图提问、文内实时翻译、插图生成，写作时可精准修改局部内容（如替换案例或调整字数）。

*   生态与扩展潜力：未来计划支持Excel/PPT解析、多设备同步（如AR眼镜），并开放API与第三方工具集成。
...
*   支持一键将智能体发布到腾讯系各渠道（如QQ、微信客服、小程序等），并提供 API 接口便于集成到自有应用，实现广泛触达用户。

官网：https://yuanqi.tencent.com/

1.适用场景与推荐组合

*   内容创作者（自媒体/文案）：首选腾讯IMA，AI写作模板（如小红书/朋友圈文案）+ 全网信源搜索 + 文档智能分析，快速产出优质内容。

*   电商/社群运营者：首选飞书，整合沟通（群聊/机器人通知）+ 多维表格（订单管理/用户画像）+ 知识库（SOP沉淀）。

*   教育/咨询从业者：首选Notion，搭建课程库/学员档案数据库 + 关联知识图谱。

*   独立开发者/设计师：首选Notion，项目管理（看板视图）+ 资源库（设计素材/代码片段）+ 嵌入式原型（Figma/GitHub）。

*   企业级AI应用开发者（中大型企业/微信生态服务商）：首选腾讯元器，AI智能体开发（客服/营销机器人） + 多源数据接口（CRM/ERP对接） + 微信生态一键部署，实现业务自动化升级。

2.避坑指南

*   不要盲目追求All-in-One：Notion虽强大，但过度定制会浪费时间，副业初期建议用模板（如“极简创业模板”）而非自建系统。

*   警惕“功能冗余”陷阱：飞书适合需高频内部协作的团队，若仅需文档共享，直接用腾讯文档（更轻量）+ IMA组合更高效。

*   AI工具需结合场景验证：腾讯IMA的文档分析在法律/财务领域仍需人工复核，但用于市场报告摘要、作文批改等场景可靠性高。

*   数据迁移成本：印象笔记导出格式受限，若未来可能升级工具，优先选支持Markdown导出的Notion或飞书。

3.总结建议

*   极致性价比方案：腾讯IMA（AI提效） + 飞书云文档（基础协作）

*   企业级AI中枢方案：腾讯元器（智能体开发） × Notion（业务建模） × 飞书（执行落地）

*   深度知识管理方案：Notion（主数据库） + 印象笔记（碎片信息入口）

*   新手友好方案：直接使用腾讯IMA，满足从信息收集、AI加工到分发的全链条需求。

*   单人轻量化：优先选AI加持的免费工具（如IMA）。

*   AI驱动型小团队：飞书（协作主干） + 腾讯元器（自动化中枢） + IMA（内容生成）

*   长期主义者：选择数据可迁移、生态开放的工具（如Notion），避免被单一平台绑定。

# 贰 | 打工阶段 💻 WORKING PHASE
...
![](img/940e05d393411dd3cbf9ab0e013cbbe3.png)
...
![](img/b52d05dae67fa033126d8b430f1ee6e4.png)

（2）时光序👍️

一款集多功能于一体的效率管理类App，功能很丰富实用，我一直在用，之前买的终身VIP好像是99元（现在好像不止了……）。

*   任务与日程管理：支持创建待办清单、设定提醒，并采用“四象限法则”（重要/紧急分类）帮助用户优先处理关键任务。提供日程表视图（日/周/月），直观管理时间安排。

*   习惯养成与目标追踪：自定义习惯打卡（如早起、阅读），记录完成情况并生成统计图表。支持长期目标拆解为阶段性任务，跟踪进度。

*   效率工具集成：番茄钟​、倒数日​、备忘录。

*   生活实用功能：生理期记录（女性健康追踪）、记账、课程表等，覆盖日常需求。
...
*   适用场景：手游挂机刷资源、短视频/直播账号养号、微信/QQ多开等。

*   可同时运行多个虚拟设备，每个设备独立IP（需付费），实现多账号并行操作。

*   支持脚本录制与自动化任务（如自动点击、循环任务），提升效率。

*   基础版：约30元/月，高级版：约60元/月
...
*   直观的可视化界面：Make提供了直观的可视化界面，使得即使是没有编程经验的人也能轻松创建强大的自动化流程，降低了技术门槛。

*   广泛的应用集成：Make支持与数百种流行应用和服务的集成，包括社交媒体平台、生产力工具、CRM系统等，用户可以将几乎所有日常使用的工具连接起来，创建一个无缝运作的生态系统。

*   强大的数据处理能力：Make不仅能简单地传输数据，还提供了强大的数据处理功能，如过滤和排序数据、转换数据格式等，使其成为处理和转换数据的理想工具。
...
*   直观的拖拽操作界面，无需编程基础即可设计复杂工作流

*   可通过连接不同节点（如 Google Drive、Twitter 等）构建自定义流程

*   支持 200+ 应用（如 Slack、数据库等），实现跨系统数据流转
...
*   先看工商信息，看注册资本、实缴资本各多少，看成立时间最早是什么时候，看天眼评分是多少，看经营范围都有哪些……
...
![](img/d5368e4993983969295863056e453117.png)
...
![](img/ebd2aea07be205292c601c09036b9501.png)

（2）飞书

文档模板有很多工作、KPI 管理模板，选择合适的来用就好。

![](img/03616562f6f4135beeb76801cdb62695.png)
...
![](img/33f5f9ce4c554c15f732899cf6f55c27.png)
...
![](img/06b30f563b75d2bb314849cfbd3ac08c.png)
...
![](img/b8b55f293426d65b80a36514487aee48.png)
...
![](img/506d5baa5297dadd968c71b30f09ef8e.png)
...
![](img/29f3482760a0260858f36b479f678ca1.png)
...
![](img/9967642c50ba1d9727195ce789603c88.png)
...
# 叁 | 创业/副业阶段 💵 ENTREPRENEURIAL PHASE
...
![](img/4d85c5dd191dad3748d7b3a97bc0a620.png)
...
![](img/6263ca8f8fd2964be4afb81a36e26f92.png)
...
![](img/0530d0a0df08582a300ced1a0d716f4a.png)
...
![](img/c8097869f7bd4ea47e08a17907dfbba2.png)
...
![](img/6f63025c2f8a6bc1c73a5c776c62e4dd.png)
...
![](img/7f69c11ac4fc8dea9e4009f8185260de.png)
...
网址：https://fuwu.taobao.com/ser/list.htm?searchType=service&firstCategory=57030001&secondCategory=205779207&sort=default_sort&sortDesc=true&pageSize=30&currentPage=1&tracelog=category
...
![](img/df8a2e57c86e153aba2c4178e3096512.png)
...
*   多语言支持：可提取视频字幕（如英语、日语等），辅助教学或学习。

*   附加功能：支持收藏台词、分享至社交媒体、设置手机铃声/壁纸，以及每日随机台词推送（手机版功能）。

*   网页版功能描述较新（2025年发布），客户端信息多为2023-2024年数据。
...
![](img/ad14dbd0568b360ca24c0373512f8fc5.png)
...
![](img/ced07bd42771de2c741373febdf0fbb0.png)

（2）YewTube Trending

同上，也是一个开源的、隐私友好的第三方YouTube客户端，通过“Trending”页面，可以查看YouTube的热门趋势视频，无广告干扰。

网址：https://yewtu.be/feed/trending?type=Default&region=US
...
![](img/6e10057b808927b6482aabb99bf4a1b3.png)

![](img/b43249851e4dcc2f72a3e938074aa4f7.png)

![](img/9d3bb5f99ac63d9890494df0a268f336.png)

![](img/5af0f0dc5c4a933ba8a94223373faf31.png)
...
![](img/aa8ab7b8df8820a51146153501132841.png)
...
*   一站式视频优化解决方案：TubeBuddy插件为YouTube创作者提供了一套全面的视频优化工具，涵盖了从视频上传前的关键词研究、标题和描述优化，到视频发布后的标签管理、A/B测试等各个环节。

*   提升视频排名与观众参与度：通过集成AI技术，TubeBuddy能够分析视频表现，提供精确的数据分析和优化建议。这有助于创作者更好地了解观众需求，优化视频内容，从而提升视频在YouTube上的排名和观众参与度。

*   高效管理视频与频道：TubeBuddy插件支持批量处理视频，如批量更新视频描述、添加卡片或结束画面等，极大地提高了创作者的工作效率。同时，它还提供了视频发布时间建议、竞争对手分析等实用功能，帮助创作者更好地管理自己的YouTube频道。

*   丰富的功能：TubeBuddy提供了多种高级功能，如关键词探索器、缩略图分析器、智能时间功能等，满足不同创作者的需求。
...
*   Youtube货币化检查器：检查YouTube频道或视频是否已获利。

*   Youtube频道ID查找器：可以使用特殊技术获取任何频道的Youtube频道ID。

*   Youtube数据查看器：查找视频统计信息、视频类别、标签、缩略图、视频货币化状态和预计收入、频道ID和信息。

*   Youtube图片工具：查找任何YouTube频道的头像，以高质量和大尺寸查看或下载。

*   YouTube标签提取器：可以快速提取任何youtube频道或视频的标签，查找频道或视频关键字。

*   YouTube 影子禁令检测器：可快速识别是否有任何YouTube频道被影子禁止，它还提供有关通道的全面信息。

*   YouTube金钱计算器：可以轻松计算任何YouTube频道、视频或观看次数可以产生多少收入。

网址：https://ytlarge.com/

![](img/249b8604a8a2377715371794436c6a7c.png)
...
![](img/4344d836c6ef085d5addd4e92385ca11.png)

![](img/ee16d90222b319d925cfe47143a45e18.png)
...
*   主力选择：ChatGPT/Claude 3.5 Sonnet - 专业性强，代码质量高，适合技术决策

*   本土化需求：豆包或通义千问 - 中文理解好，合规性强

*   成本考虑：DeepSeek - 开源透明，性价比高
...
*   文心一言：中文写作的好帮手，尤其擅长生活号写作

*   ChatGPT：创意多、国际范，但需要科学上网

*   Kimi：新玩家，但中文理解力超强，特别适合长文创作

*   Claude：逻辑鬼才，学术文风的首选，也需科学上网
...
![](img/24d755caab2822948a669d972f7655c4.png)
...
![](img/2b87a6d117c0a52a81b98b5104825e5a.png)

（3）团子AI

音频智能工具，包括：

*   伴奏人声提取：上传任意歌曲，提取该歌曲的伴奏和人声

*   任意乐器分离：在歌曲中分离、提取或删除任意乐器和声音

*   无损升降音调：利用AI对任意歌曲升降调，但不损失音质

*   新混响回声移除：无损的清除人声和乐器中的混响、回声
...
![](img/dfcf6a704294d3979da85f98157fbcd4.png)
...
![](img/96810992f87493be1514d1faccaca683.png)

![](img/dde6a867f5e0496b125a00b07d7ef8dd.png)
...
![](img/ddbc05651a1803dc0aaf53379eec7173.png)

![](img/e789c699f58cc9d36f49832d1c33f7e6.png)
...
![](img/570a9037a913e375d25181e70a056ae7.png)

![](img/03e91c6e92999a5623acf54e2193cb93.png)
...
![](img/88ab4e3be282ec81650c47eee41ae9cf.png)

![](img/b79830884c0ec8334d622988e940dccc.png)
...
![](img/7637b8b2bbc8895844386e27c706920a.png)

![](img/4f670c92ad58b82660551ed7eba0f3bf.png)
...
![](img/376dde9d5285bf84698e9a8d0b88f805.png)
...
![](img/95cfa682c2c7952b7a34846373dd83e6.png)

🤝交个朋友，未来或许不止是朋友🤝

![](img/f7c2995db16806482bb5c094bb33f55c.png)