...
> 来源：[https://lv9qj6hfr4z.feishu.cn/docx/IpX1dQ6DGow2WnxFe66cdM2Gnjb](https://lv9qj6hfr4z.feishu.cn/docx/IpX1dQ6DGow2WnxFe66cdM2Gnjb)
...
1.  在闲鱼搜索（文章 撰写）等关键词词，然后找几个帖子数据不错的对标账号。

1.  参考对标账号完成，完成账号包装，并且熟悉闲鱼常用功能。

1.  了解闲鱼引流的课程体系，学习相应的引流话术。

1.  使用手册的发布方法，每天至少发布 1 条闲鱼帖子(建议3-5条)。（小ts，建议在一些链接流量比较高的帖子下边，卖同款那个入口进行售卖，有截取他流量的可能）

1.  每天寻找至少 5 篇对标图片素材和文字素材，持续补充素材库，确保有源源不断的内容发布。

1.  帖子有曝光后，浏览增多，想要不多的时候，要果断降价！每天降价一次！多降价！

1.  使用手册的私欲转化 SOP ，完成第一次私域转化，智能自动回复哪里记得打开！

1.  持续复盘笔记、引流数据，优化帖子内容和引流话术、提高引流成功率。

1.  复盘引流转化数据，结合飞书的引流话术指导优化并搭建自己的转化 SOP
...
![](img/296070a307e992b33c9a3e086c50189a.png)
