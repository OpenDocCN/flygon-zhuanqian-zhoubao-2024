# 怎样通过Cursor编写有一定复杂度的产品？怎样让多个AI相互协作结伴编程？

> 来源：[https://kxgiimtbac.feishu.cn/docx/GCIadxlmZo0jdMxtNX6cbvOsn3d](https://kxgiimtbac.feishu.cn/docx/GCIadxlmZo0jdMxtNX6cbvOsn3d)
...
![](img/4b656bb9ffd8ad02989bbbc4031c6a8f.png)
...
## 怎样用Cursor的Composer启动编写一个时间块小程序？
...
![](img/d18567c8f373050a6c086c2f981fa884.png)
...
![](img/25d0350de2c5467585d35741ae47e218.png)

我们可以把这些报错信息复制粘贴给Composer进行问题修复：

![](img/bf46d310ea765281c6c0b99dcb1ddc67.png)
...
![](img/c6c850c6c4fbcc70527ea757d9327a77.png)

![](img/e663c77e7a0c83962dce00742641ec2d.png)

![](img/253b9063f6db850d05d740a71ee1d47a.png)

![](img/46d9629c12a7b26d7f7efb13985c515d.png)

### III. 怎样通过Cursor给项目增加新的功能？
...
![](img/6e1eaa61c8a5bd889f0f4f2e3782780a.png)
...
![](img/d1ecafafada9bc1ca1dff8a7a3c46cb9.png)

### IV. 怎样通过Cursor做项目的二次开发？

打开项目之后，我先用Chat的Codebase模式熟悉这个插件并做简单的分析：

![](img/cb751183c768e814840d68288c69388b.png)

![](img/ddca2e699efe7306f7cb482f1bd5711f.png)

Cursor有模有样地帮我做了一番分析，涵盖这个插件的部分主要功能，但是并不完整。不过这怨不得它，因为这个插件的核心js文件的代码量已将近1万行，早已超出Cursor调用的Claude3.5的上下文长度范围。

![](img/9ebd148282559f6db1066bca1160cfef.png)
...
![](img/91c4835921a8d9519e448e28c647ad13.png)

![](img/ce9d58bc1c62a168e43628a05b20090f.png)

![](img/cf34792b705eeb039f48cf621cc0635a.png)

![](img/b9784564d04c968f5f5b56ae39564c23.png)

![](img/7ad12038a8fc55716a56db6ef3194068.png)

![](img/f907454bd1bd5c49a31c22fe71189e1e.png)

![](img/98760cfab00efac039f7c3a295840ca7.png)
...
![](img/b1966ecf8db5623cbe892c99e7fadeb2.png)

![](img/5d4b2524f42ee5a7723af524b01a59e8.png)
...
![](img/bc5768333664327796db05fd6a727a6b.png)

![](img/b4a2e5ad5f612bda74bfd6b58b419b67.png)
...
![](img/6299b5ebc5fa4af79c2174209dac8284.png)

## 怎样让多个AI相互协作结伴编程开发一个WordPress主题模板？

### VI. Cursor的Composer和Chat有哪些特点和区别？
...
![](img/54032783fe4915b416d8d0dfbbabdd25.png)

### VIII. 怎样通过Cursor的Composer和Chat相互协作结伴编程
...
![](img/bd0e05243ff27e037c43cef120c39c68.png)

*   首先是我们的产品经理（其中一个Chat），负责整理项目需求和规划开发步骤；

*   接着是我们的核心开发骨干Composer，负责根据产品经理制定的需求方案和开发步骤生成代码，并掌握整个项目的流程和进度；

*   再接着是多位代码审查专家（其中多个Chat），负责解决Composer编写的代码中存在的问题；

*   最后是我们的UI设计专家（其中一个Chat），负责做一些样式优化和处理。

为什么要做这样的分工和安排呢？Composer不也一样可以审查修复代码吗？Chat不也可以根据我们的需求做开发吗？ 这是因为基于以下考虑：

![](img/c2584dbe5515b5c61fa4171a8100241b.png)
...
![](img/4b2fcfab461a05c4848168f31c316302.png)

![](img/576e99c9662aa3359d70edbc957e6fe9.png)

接着，我们开始让Composer根据产品经理整理好的需求文档开始做开发。Composer很快帮我们按步骤输出这个主题的相关代码：

*   实现步骤1创建基础主题文件：

![](img/5a6d1f3340c3a275a671ca25913795a9.png)

![](img/7c4e5034669a28f0a8e8b648414d8243.png)

*   实现步骤2设置主题基础功能：

![](img/d8b7d12b844b00f84cfad15ebc7dac5a.png)
...
![](img/093b76090beda586030e787bced8f806.png)

![](img/c384076e41b91edb8ebbd18550138f79.png)

![](img/6a11e7707a5300b57480081ec8dd3ee4.png)

![](img/f1f8072cfbb9dd1dde89e076e8023a73.png)

很快，Chat修复了这个问题。我们告之Composer并让它继续做下一个步骤的开发：

*   实现步骤3构建基础页面结构：

![](img/9d4399987e09413e1b63a28b29a3c4a4.png)

![](img/cb73593340fffc18824f3b6e683b2747.png)

很快，Composer帮我们实现这个主题的初始版本。接下来，Composer开始进入状态，连续帮我们输出几个步骤的代码，并且测试没有发现明显异常：

*   实现步骤4添加基础样式：

![](img/7d79dade05ca71a0401969fb2a71a653.png)

*   实现步骤5实现文章列表：

![](img/c6bdd017c40625700c16c4c73194e581.png)

*   实现步骤6实现文章详情页：

![](img/ce3bb4df9ea307ec0d2cf87dfd33819a.png)

*   实现步骤7实现侧边栏：

![](img/980575117b4739a2f82fa5ce87497e4b.png)

![](img/f372221ddc17323b22fb2c1d034ca9ce.png)

*   实现步骤8实现评论系统：

![](img/1dc89b4b923426d3fd2e5c68d07c8ee8.png)

![](img/b10639bcd3ff4e6a88c02f41b8b64846.png)

![](img/4ba8ea295afa312ef11a626e10df1ef2.png)

*   实现步骤9添加响应式支持和步骤10优化移动端体验：

![](img/3e40f798b698778db7098ac248f58184.png)

![](img/bcf6393e991a45f09484dd4fca3f4e04.png)

实现了这个主题模板的一些基本功能，直到第10个步骤，才又遇到了新的问题。我们同样让Chat修复这些问题：

![](img/e830b1a08793fa0e8d3aaa9c57d3344c.png)

![](img/ff5b7cfb5d4b8af60d3361168934197b.png)

![](img/41677630263b352582ed4286bf72eb80.png)

然而这一次Chat修改后出现了其它问题：

![](img/2eefc2ed27dd0f6570dd679f5cffdcaf.png)

修改后仍然出现报错，我们把报错信息复制粘贴给Chat：

![](img/2fbff21a43999c5229b9e1c2906d090e.png)

连续和Chat这位代码审查专家回来对话几次，最终我们解决了这些问题，实现了这个WordPress主题的雏形：

![](img/dc87f9c9486fcef2931c8b4d6cb39169.png)

我们同样把代码审核专家Chat的修复结果告知Composer：

![](img/725112be0907ecff79fbd6587a33071d.png)

然后，让Composer检查一下项目进度：

![](img/079b67841569bb36c2ecabd680106d21.png)

![](img/5c3647bccbcfcc5414e601df13cbe0f1.png)
...
![](img/7b56a12a811bbc86e2e387daf08c0d30.png)

这个时候，我想优化一下这个主题的UI，自然得把我们的UI设计专家请出来：

![](img/3260980d16ccbb2895f5dda2e349f361.png)
...
![](img/cdd637c20cf1551e8f92d89332d8b480.png)
...
![](img/7e978488753fbb15acc45a44b89160a4.png)

![](img/8b884b463b5b471605a2f00cfacd4f66.png)

我们可以根据我们的实际需求和这位产品经理多次沟通，最终确定下来我们需要增加的需求，并让这位产品经理把新增的需求和开发步骤添加到原来的需求文档 readme.md 中：

![](img/46e27032f86bb906ffaf44e5c691fc1a.png)

![](img/3369fea6b93b53df95806b276dffff43.png)

接下来，我们重新让Composer开工干活，先让他根据最新的需求文档检查一下当前的开发进度：

![](img/bc89f53955ccb679a1c8f1e2f6030969.png)

![](img/a7bbf0a401b84bbb622d6087eac9da20.png)

然后让它开始生成新增功能的代码：

![](img/145ca1f63b8a0fffed2b8c8ef451537c.png)

![](img/46446a96bc065ded6660dbf41ca83f39.png)

![](img/b3887195ddba8786c4a913d33c624e4e.png)

Composer生成代码后，我们同样在WordPress网站端测试，如果发现问题，同样可以让代码审查专家Chat进行审查和修复：

![](img/14a4685c31a31c2f41356efc2dd7c097.png)

![](img/e3ca0a4a8b46403e6178413f8f0c1009.png)
...
![](img/69170290360998b9baa4a502d9639e07.png)

![](img/2b6d72948cf31caa914ff36a316b78bd.png)

![](img/c6626a1dfa5fd9882fbaf2495d439a3c.png)

![](img/02cc2e8e544e61e20d80ed8f83b785ad.png)
...
### 附录I. 通过ChatGPT整理时间块小程序的需求文档和开发步骤

![](img/19a465a9c4902c355ecfc4691614bc4a.png)

### 附录II. Cursor的产品经理(Chat)整理WordPress主题模板的需求文档和开发步骤

1、让Cursor的Chat扮演一名产品经理，负责整理项目需求文档、开发步骤和文件结构：

![](img/e1a57aee30b3e7550434853c3b6a9b4a.png)

2、联网学习JustNews主题模板的功能：

![](img/2a1fec4cf36ebfc036ae7247dd3532ce.png)

3、罗列JustNews主题模板的功能列表：

![](img/7c1ccf0598ddde17fd880d0d44c826b5.png)

![](img/dc3e886ad49d41a4ac20b1e3c23acca0.png)

![](img/0a1a10ea8168e4beb179fb45e9dc376f.png)

![](img/f98b09076e94596c2bb6163e252b4eb1.png)

![](img/a23c5c33354b2aaff8f4927aa2f1d3be.png)

4、提取JustNews主题模板的核心功能：

![](img/d585a563e55965376a88b1877c4c592f.png)

![](img/4af56064bd08d668e8e30700094ee985.png)

![](img/e3904394f23f80c64e2b9ba9bbc824bf.png)

![](img/7e102536a23b4c9eb29bf35d6978783c.png)

5、把提取的核心功能整理成需求文档：

![](img/9f4ffe90af5f2c48b3ebfcb13c2474f6.png)

![](img/4f3e3615852a35e8381ca8cf791a1813.png)

![](img/4f9cc17f40b7cdb852b8b7a794eb5298.png)

![](img/b0aedd56a9d36105a1a5a44af8cbf865.png)

![](img/1133b6ab1885aa4837bf1e62f87d4459.png)

![](img/ee77326e2c0b463fe5759a97f2cb149a.png)

![](img/ff81241d6d873c1acad3fe53fc5fea9c.png)

6、把需求文档保存到项目根目录中：

![](img/1fe186e36c08c1910b307d7da49a4f27.png)

7、细化需求文档中的开发步骤：

![](img/4e2291f1ee99d8ab159c11302498a988.png)

![](img/1e4b366d490e06a5483490025b415457.png)

![](img/84578344b88228b1c57e314dd8fac87b.png)

![](img/517f49a68c44b7867cb02f5f0d112d36.png)

![](img/40ff65c1e7567bb1d4aadb900c6d5b1c.png)

8、更新细化的开发步骤到需求文档中：

![](img/44f9fb05f795ab317bb0cd6373b8f0f4.png)

9、重新梳理项目的文件结构：

![](img/51785ec61873b455cd70b6181a971a4e.png)

![](img/5d5abce17dd47cb8d3fbcfad4697c98e.png)

![](img/03dd3f6b8d8fe6912edb1b523ef00921.png)

10\. 更新最新的文件结构到需求文档中：

![](img/c92e5c4b526274b8cf4549923acd81e6.png)

### 附录III. 和Cursor一起探讨Composer和Chat的编程能力

![](img/b6bb5b7e6bd77391b0898381026565f3.png)

![](img/bdbf14d2903acbe987bdbb25ab1f9865.png)