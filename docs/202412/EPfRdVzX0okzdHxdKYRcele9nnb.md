# 从0到1：如何用cursor AI编程做出机械行业新产品评估自动化程序

> 来源：[https://fnuz0veosn.feishu.cn/docx/EPfRdVzX0okzdHxdKYRcele9nnb](https://fnuz0veosn.feishu.cn/docx/EPfRdVzX0okzdHxdKYRcele9nnb)
...
![](img/6c8ea3eea4f94cfa20a1ffdb087b926f.png)
...
![](img/c769fbedc0782b7df46124a301752c54.png)

![](img/a7f8bef64eda0353fbc27b5d4e33b694.png)

### 2.3最少必要编程基础知识（有编程基础可跳过）
...
![](img/5ab477e7b2f230649d45a248260457ad.png)
...
![](img/7db178c15e8b147cb53bd0b4791088d0.png)
...
*   输出区域：显示程序运行结果或调试信息的地方。

*   文件浏览器：查看和管理你所有项目文件的地方。

*   调试工具：帮助你检查和解决代码中出现的问题。

![](img/15e9300154a385ea53c5adb92919799b.png)

###### 命令行/终端

命令行是一个文本界面，你可以在其中输入命令并执行。对于 Python 编程，命令行通常用来：

*   运行代码：输入 python 文件名.py 来运行代码。

*   查看错误信息：如果你的代码有错误，Python 会在命令行中显示错误信息。

*   终端：用来输入一些安装命令或者调试命令

![](img/60e4494b88429eaf504cd703310f5ed1.png)
...
![](img/dd9d92de40db5fb9c9751761d88ab9a3.png)
...
![](img/eb24eef74579636b336d2c7ece6a2c9c.png)
...
![](img/e078116406192ebce18f19db1e59040a.png)

###### 赋值语句

赋值语句 是将一个值赋给变量的语句。用等号 = 来表示赋值语句，左边是变量，右边是要赋给变量的值。赋值语句会把右边表达式的结果存储在左边的变量中。

![](img/ab604b9e635a7ebe6ced0451ee9d9aa8.png)
...
![](img/a7d589b3b4e7a34690914f069b69fbb8.png)
...
*   浮点数 (float)：比如 3.14, 0.001

*   字符串 (str)：比如 "你好", "Python"

*   布尔值 (bool)：True 或 False，用于表示对或错
...
![](img/0be96ee26dd69b04d3d534f0f44206e2.png)

###### 函数

函数就是一个算法盒子，可以接收信息，然后按照算法逻辑输出信息。在 Python 中，函数通过 def 关键字来定义，函数可以接受参数，并且返回一个结果，即返回值

![](img/915a7c2584ae43fddc5f3e2f1a5f49ed.png)
...
![](img/785117f5e1e2c081551862b327a0711d.png)
...
![](img/84627adf5acf6072973e7fa7e3dff62e.png)
...
![](img/5f4670f17b11990dbaa16f485e411d11.png)

![](img/648ec9442f7e9de14f001cf3b404a99f.png)
...
![](img/f15b97197d2d894aad4103d97f312fe5.png)

![](img/774e50b785d2053164c5066b142f1f9a.png)

接着是创建编程文件和程序框架

![](img/a3f6d272999d7214ad8d2b9da64bd20f.png)

![](img/00d6b8d0267f9f358bc7dd0ee345ab8d.png)

#### 3.3 核心算法一：评估产品差异，找到相似量产产品

写第一个模块，查找相似产品部分，我提供了整理的产品数据库，然后AI编写了第一个模块的代码。

先引入一些必要的存储、读取、计算的库，然后确定计算相似度的算法逻辑，同样是让AI告诉我替换那段代码或者提供完整代码。

![](img/82c557e2407951866781202cfbed3503.png)

![](img/dbc394e6e125357195579f06384f78d6.png)

![](img/740be347b582051ce1c17ca6fc160ad5.png)
...
![](img/f7c859af050001556a9aac9241e08881.png)

![](img/353f1dae55f82d4b96635771d734447d.png)
...
![](img/99b3fcec421aa2c8ed7bc54da9edf168.png)

![](img/e78ee380da2e8b45009417ddbcc7903f.png)

但是在我进行下一个模块的时候就发现问题了，1.0版本在电脑上很容易出错，要么上数据库容易乱码，要么就是输入参数不符合逻辑之类的。然后就是一步步解决遇到的问题

*   数据库格式问题：一开始使用CSV格式时候，看到读取文件的数据类型是'utf-8'或者“gbk",反反复复搞很多次后突然意识到很多软件都是直接扔excel文件，我这个应该也可以呀，于是问了一下AI发现果然可以，所以我折腾好几天是为了什么、、、、

![](img/78401f7c8be9af399c6a7045742e872d.png)

![](img/d6ab494ffbd8a3fc042dd9213516f611.png)

*   输入参数不符合逻辑问题：我们的产品是轴承，有”外径大于内径“这样的逻辑，为了以防输入参数错误，我又加入了参数验证环节。

*   强行提供相似产品问题：测试发现有时候是一个全新产品，全部参数都不一样，结果还是输出一个相似型号，于是又增加至少两个高权重参数完全相同才能输出相似产品，否则就是全新产品。

诸如类似的各种调试问题，多轮测试下来对输入界面的需求就很清晰了。

要有参数输入界面，要能自动选取数据库，输入参数要进行逻辑验证，全新产品则不需要提供相似产品，还有输完一个参数按enter就进入下一个参数等等

![](img/d1a136f09829cf8dbaa23793eb029caa.png)

![](img/e4d30e9e4bd26578057e3e02602d90e8.png)

![](img/d9d5d35beecaf7650542175f04dde9a3.png)
...
![](img/395e5428a12de8abf1614d6a7848a92b.png)

![](img/52832660ae10154757f6bba2b5b4f8fd.png)

![](img/d786f6a2c2c2a0630acb67dfb5ce0cee.png)
...
![](img/99b0f5da3165f4e44b122066bb05e775.png)

![](img/1810f5b91849694849680ca24e4bb036.png)

![](img/6f61a3f5ebcfd23f89d9729d4f783db1.png)
...
![](img/245ba565b0dc576d99a007a5f60f5f75.png)
