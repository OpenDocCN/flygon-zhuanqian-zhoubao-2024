# 小白 29 天 YouTube 开通 YPP 复盘（男保姆版）

> 来源：[https://ntb7l7i3sy.feishu.cn/docx/CNnYd18U6oTmyexRLYPcznYJnjb](https://ntb7l7i3sy.feishu.cn/docx/CNnYd18U6oTmyexRLYPcznYJnjb)
...
![](img/f713dc4c9134f22f6384552b427fcaba.png)

![](img/63ceea288157c5718c66c2554a275e35.png)
...
*   查看账号的 Shorts 最早发布日期，近 3 个月最佳。账号注册日作辅助参考，避开印巴

*   赛道尽可能结合自己的兴趣点，驱动力更强更持久（成事三角形：方向、动力、能力）
...
![](img/e0d57259813adf08a6269a3c697070f8.png)
...
*   竖屏选 768×1280，模型选 Gen-3 Alpha Turbo。

*   如果生成的视频很满意，可以继续用 Fixed seed 的数值反复填图。

*   选择 10s，满意的话，用 extend 多拓展 8 秒；或是保持 Fixed seed、prompt 不变，批量垫图。

![](img/260869ec8003e085601388b2296796b3.png)
...
1.  标题、标签、分类、时间等都可以完全对标账号。

1.  对标视频标题投喂 GPT，让它模仿改写

1.  YouTube Tag Extractor 提取标签，有一键复制的功能。如果发的视频类型固定，可以在后台【设置】的【默认上传设置】中提前填好标签，之后发视频就不用反复填了。

![](img/006d935080b6b21c307366c61e2a8c11.png)

1.  ytlarge 可以查视频的分类、发布时间。不知道怎么选，就先向对标看齐，后面自己的数据起来了再按自己的观众来定。

![](img/82142fdff3d587b20a966fbb093aa32f.png)

# 运营频道

1.  多和评论区互动，尤其是高赞评论，可以间接提高视频活跃度，带动平台推流。

1.  发布前，可以在【相关视频】添加近期爆款，被平台验证过的优质，说不定二次小爆，长尾流量。
...
*   下次怎么更省时地批量出图、prompt 怎么更稳定？

*   建个文件夹放 prompt 模板，少手搓一点是一点？
...
![](img/28f79d5a9d50e32db1a8588863f9f84f.png)
