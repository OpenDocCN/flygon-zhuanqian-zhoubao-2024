# 如何只用cursor搭建一个功能完整的网站

> 来源：[https://gida8fb9mrg.feishu.cn/docx/Cd3idRpd6oabQ3xpwQLcRr4QnCQ](https://gida8fb9mrg.feishu.cn/docx/Cd3idRpd6oabQ3xpwQLcRr4QnCQ)
...
1.  智能代码补全：借助 AI 技术，Cursor Composer 能够理解代码上下文，提供精确的代码补全建议，减少手动输入，提高编码速度。

1.  代码质量提升：Cursor Composer 可以自动检测代码中的潜在问题，提供优化建议，帮助开发者编写更高质量的代码。

1.  个性化定制：支持导入 VS Code的扩展、主题、设置和键盘绑定，开发者可以根据个人喜好定制编辑器环境。
...
![](img/a29eb5c4a8f315a93b281fac3751c7db.png)
...
![](img/9b30cfa5faad220a9315f9392344a8c4.png)

1.  被限制之后如何免费使用

cursor开始限制免费次数(原来500，现在250)，也限制了一台机器不能无限制登录免费账号。这时候只需要在插件拓展搜索fake插件安装后重启cursor即可。

![](img/31d735e26bac196d37795d73eda7fd4e.png)

1.  Cursor 允许你使用自己的 API 密钥，以便以自己的成本发送无限量的 AI 消息。

![](img/1a459f7218c55d8e1cdc4f26586be486.png)

![](img/264bbb2e921d6a8e7560cbce26b585f5.png)
...
![](img/b49044d0a1ae5542cd607602a813ac33.png)
...
- `git push -u origin [branch-name]`：将新分支推送到远程仓库并设置上游分支。
```

![](img/849f1cf4379c881421ebfbe649a8178d.png)

![](img/4e29cd4a31acee6db6cc6ff01dd22bcb.png)
...
![](img/c68a3ddac96e1b6563b38eaeca79517f.png)
...
![](img/042e4e2b0894e5b801914394b11989d1.png)

![](img/1a00045ce5ac27b31c3e50f4e092ccde.png)

![](img/92361d874522db623ab75dcb96b9749a.png)
...
技术栈：next.js
```
请你帮我设计项目的前端、后端、数据库、api
```

![](img/7e679046742f0ea44e14c88ff637f509.png)
...
1.  会生成一些用不到的文件，文件多了，你看起来麻烦，cursor看起来也麻烦，毕竟不是cursor自己生成的
...
1.  因为上一步你告诉cursor不要生成代码，所以他不帮你生成文件，而是给你代码，文件要自己创建

![](img/bb4429db83df21efce0e06e9f6565ac4.png)
...
![](img/66d0ffe312036d9ca0f9ed743eafc323.png)

解决这几个问题的办法就是，新开一个composer窗口，并强调你的需求

![](img/69f8cb8c27fec51ff0dcdf75d118a2f2.png)
...
![](img/3b9d83b21f5f2b5c55beb2c596f89442.png)

又或者在设置里手动刷新缓存

![](img/3fa050b1c2e2da27f5962d48d54dc103.png)
...
![](img/2548936a0dcfa0db329559e10f1d0337.png)

如果执行npm install很慢，可以配置国内源

npm config set registry https://registry.npmmirror.com

![](img/ecd25ffbc27daccf1fb9472160ee3d42.png)

![](img/f67e37cb35fc25505fafed737c734ca4.png)
...
![](img/c89c3860a874c3616c5d879325a82024.png)
...
![](img/0d942b7867ee2294e711c06460387ef2.png)

![](img/f8a885db1599bdab99aeb337dbd65bb1.png)

整体的登录页出来了，但还是有点问题，没有居中，也不美观

![](img/255dfff466d6e959498e707a44bc0970.png)

继续优化

![](img/0ef59ec15ddaab19e779058f21ea2095.png)

![](img/f0bc3e579c3a157ec78121e0aebeb92a.png)
...
![](img/b903cca32d4efc0a169bf617e320a47f.png)

![](img/fe634ee154a3302bbded34984aec493a.png)
...
1.  截图，然后让cursor根据图片生成代码

1.  复刻的网址需要登录后才能访问，这时候可以打开F12，然后复制代码到本地文件，并@本地文件，让cursor分析文件

我们来演示第三种方式：比如要复刻这个界面

![](img/459b05d86bf9f0327091353d0e982e41.png)

因为需要登录，所以F12复制代码到本地文件

![](img/0d33c35b51fc33802b6595c177897b62.png)

提示词

帮我复刻一个如文件所示@loyout.txt 的界面布局

![](img/7194c33bb83c3f23123fd6621b4414a6.png)
...
![](img/64cd3ed2bb1be2301bea88b4b49e6980.png)
...
```
结合 @README.md 系统设计及以下需求，帮我生成用户管理系统:
1.当我点击学生管理的时候，内容区会显示对应内容
2.使用sqlite数据库存储学生数据
3.需要有搜索、增加、删除、修改功能
4.初始化的时候，如果数据库的学生表是空的，则插入10条示例数据
```
...
```
代码报错了，报错信息: """报错信息"""  
如果是因为缺少依赖包，你应该把依赖包写到package.json文件中  
```

![](img/94f25ae82a1b62be313381976d9ec926.png)

解决完报错界面直接就出来了，我验证了一下功能，除了界面丑之外，功能完全没有问题，运气好的时候会这样，不过大部分时候，还是会有一些错误和小bug。

![](img/e2f8b771eea4fe4fe025dd15583fad6a.png)

这里我根据自己审美，写了提示词让cursor优化

1.  删除文字"添加学生", 删除姓名、年龄、班级输入框

1.  把搜索框移到添加按钮的左边

1.  添加和编辑学生信息时，以侧边栏表单方式让用户输入数据并发送请求

1.  编辑学生的时候，要把学生的信息填充到表单中

![](img/7677d4f4030051f5e9132d79f5b6499f.png)
...
![](img/873ce1f83e1bc129a2eca4bbcc9962c8.png)
...
![](img/804c1cc9e6aebf5d5be71a4ba6285ad6.png)

另外就是有时候想找一些好看的特效，但自己又没有思路，这时候有几个css网站可以试试，都是可以直接复制粘贴代码的

https://codepen.io/

![](img/8bc7714ed472818a5b2c528af77844ba.png)

https://animista.net/

![](img/ae2f9b027632f42e67b0102deedb4cce.png)

https://phuoc.ng/

![](img/c599688d4c477fdbdc0571347788fa66.png)
...
我想增加一个功能，需求如下：
```
1\. 将班级修改成kimi，并且链接改为kimi
2\. 我要复刻kimi网站，用来和大模型聊天的网站
3\. 内容区分为两部分
3.1 底部是输入组件：输入组件就是简单的输入框，用于接收用户的输入
3.2 除了输入组件，就是信息显示区，但我输入后，大模型会返回数据，数据展示区会以流式方式显示文字
```
你先重新表达我的需求，达成共识后，再进行代码生成
```

![](img/a54a60d460f99b0f4532c70db952ee32.png)
...
![](img/d0e29825bb8bdf6c80b86b4b5d3f8a52.png)
...
![](img/459588a1da6420a1f787bd894789a85a.png)

### chat聊天

Ctrl + K：打开内联编辑工具

![](img/fa978003375e509a1057186dd06bd5a5.png)

Ctrl + L：打开 AI 聊天窗口，将选中的代码发送到聊天窗口

![](img/fef4baf43d6357f24dca67fb90147dad.png)

Ctrl + I：打开 Composer 工具窗口

Ctrl + Shift + I：以全屏模式打开 Composer

![](img/b07329c62264d1fbda2dc3e704590784.png)
...
![](img/fd5c8d47c1153196eef77f433aba7673.png)
...
![](img/f3a1dbb89d7c7830460339f19b7b4955.png)
