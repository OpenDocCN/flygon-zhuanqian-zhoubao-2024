# 从 40 分钟到 10 分钟：AI 赋能下的半自动化视频创作流程分享（无保留）

> 来源：[https://ccav9ey9jd.feishu.cn/docx/VKardJt9goLf0txpzFscV7Ybnlh](https://ccav9ey9jd.feishu.cn/docx/VKardJt9goLf0txpzFscV7Ybnlh)
...
![](img/7d8d6dcc3c748613ff78751042c4fa02.png)

![](img/07a6f8ab094cda7389f67f46b75674d4.png)
...
![](img/b44d1b97b2dfd7b0ee27bdcbfd2ccab2.png)
...
![](img/c717551f0cd58b9ac11ebee5ae374f53.png)

![](img/2c2bac379c9b5bf0b9fca1f7fda5e984.png)
...
![](img/5ea9f6364531021eca6b94cd513c59c5.png)

![](img/3333e1bd60379fb77d98faa41b023d2c.png)

![](img/1dd0deef88165be3bb6845700d081c0e.png)
...
*   使用 Azure AI 直接生成跟读音频

*   使用 Google TTS API 或者 Azure TTS 生成语音

*   使用 Coze 的 API 调用智能体进行抠图处理，下载到本地，并且上传一份到七牛云，同时把七牛云网址填入 Google Sheet 的表格中

![](img/5a7289158e1640de5c55ca68f3cb7283.png)
...
![](img/7c02bae6255dd4e6c26500b1fcf607b9.png)
...
![](img/fe55b4c87c2e63f120152123624d5c9c.png)

![](img/c3fc450918709e2282b364b30139511f.png)

在 Composer 对话框里输入@后，会弹出一个弹窗，可以选择引入到对话中的文件、文件夹、或者是部分代码等等。@Web 对话就会进行互联网搜索。

![](img/f4fc35ac27503fa2296053746f232363.png)
...
![](img/4e1d4c9cba9ddce1fd5668967d7365fc.png)

此外，也可以使用 Agent 帮助我们安装所需要的 Python 依赖。

![](img/e1d25175950064459bd1a1869b5e911c.png)
...
![](img/86f7d86717bb27b1bcfe74c98e79fbf8.png)
...
![](img/217b575b6664baece10bfa40d1ededff.png)

![](img/f3c9ff9367ce47504309cf42348fe25f.png)
...
![](img/291ff9b69c3a8b061fc34d5d737ae56d.png)

理清整个逻辑后，我们只需将过程复述给 Cursor，并把文档中的代码示例和必要的参数信息提供给它，然后耐心等待 Cursor 完成代码。因为逻辑够清晰，Cursor 一次就完成了任务。

![](img/c843591f88db1a969041f54b0a4cf87a.png)

![](img/788e100f875fc5d43c488f4fc0e4e279.png)

#### f） 遇到报错 bug 以及界面卡顿等问题
...
![](img/291d3cdbab8450c0c8f2cdf82ab5a72c.png)
...
![](img/25a3cd88939f36d028b2e0ad527a119f.png)

![](img/0a5829a1e8701c4949d5920e28955e07.png)

## 2、Chrome 插件 —— 查询单词音调、批量同步到 Notion
...
![](img/17e91fd5c42757b3552bd4f7077aff64.png)
...
![](img/fc33b183a3a2c2bd7a42d8440b2137c4.png)
...
![](img/e0a46f06ff7f11dc7ede0296c1085e9a.png)

![](img/5c0ca5d6994c427fa1805fa49a5b991e.png)

![](img/7064981643f5fcffceb19a3f301323c8.png)
...
![](img/bf20ce02ea14fb1b0826023fc1850c3f.png)

如果自己有设计稿，还可以直接复制给 Cursor，让他按照设计图进行修改。下图是我在做的另一个应用，左图是我给他参考的设计图，右边是他做出来的样子，可以看到 Cursor 还原的已经很到位了，再修改一些大小和边框弧度就能跟设计图保持一致。

![](img/ebb4633e268dc44ecc92a28dcd550fa3.png)

![](img/f500854f2ea31a94a281bd571508e5d8.png)

## 3、Chrome 插件 —— MJ 图片自动下载

### 1）简述

主要功能：

*   自动下载 Midjourney 生成的图片，并自动切割

![](img/b2cfa9f0a9e500a863db86937b15c32f.png)

![](img/c33c660b4bc107a20dbf76bd3b805296.png)
...
![](img/f3709c1fba18212120e9534542e3f87c.png)
...
![](img/8d9ff0f3a78369addaa07b5c630c905c.png)
...
![](img/3396ad4e9a579a98fc23ced14c720e23.png)
...
![](img/a61964a818f03a47cfc90fbd4c945377.png)
...
![](img/5f14ed2e620ff74f46fdbb4067d2972f.png)

## 2、中文乱码问题

程序偶尔会出现中文变成菱形乱码的情况，需要修改系统为全局 utf-8，具体的修改方式可以询问 Cursor。

![](img/6b4df9edb614656a158821e562b49178.png)
...
![](img/389956ff70d466a9f7c912c42823aaa2.png)
