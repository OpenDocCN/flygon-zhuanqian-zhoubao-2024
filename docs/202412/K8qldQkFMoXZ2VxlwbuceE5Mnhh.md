...
> 来源：[https://wqm8iq5gs4a.feishu.cn/docx/K8qldQkFMoXZ2VxlwbuceE5Mnhh](https://wqm8iq5gs4a.feishu.cn/docx/K8qldQkFMoXZ2VxlwbuceE5Mnhh)
...
*   官方版Claude：上下文容量较小，即便是付费会员，文件处理能力也比较有限

*   Poe平台的Claude：表现不错，上下文容量更大，特别是200K版本，用了这么久，没有超过上下文限制的，不知道这个平台上面的是不是阉割版的，不过用起来还行

*   Claude独享号：因为一直续费的chatgpt，就找了找有没有便宜点的claude号，发现闲鱼可以半价购入，100万积分完全够用，性价比很高
...
![](img/9acb4b4da5c63fc203ac9bac33202048.png)

![](img/3d192550b3e8f92d50dfd2fe9bc269cc.png)

![](img/7d81ac8d67e5a5e8a1d300d7ed583be4.png)

![](img/c7fbcc0fa8d0ba43cdf4c524ba26bf5c.png)

![](img/14fc39bb60146e30eb7015c7e9e37d36.png)

开发经验总结

1.  Cursor的局限性

*   随着项目代码量增加，Cursor的表现会有所下降

*   需要通过详细的文档记录和合理的CursorRule配置来优化使用效果

*   建议把控项目全局，不能完全依赖AI辅助，开发的时候可以让它给你讲讲基本的东西

1.  基础知识的重要性 理解项目架构的关键要素对开发效率有提升，比如Next.js的项目结构设计原理，各个文件的功能和作用，参数传递机制，前后端交互流程，这些多问问claude，让它讲给你听稍微理解下就好。
...
![](img/e2c5d3d74b5a458cfb79e1c907e85e5d.png)

![](img/4f29041ee4ac36e9269a1ba0310a5f5d.png)
...
*   压缩包下载方式我试过有些问题（可能导致文件重复和结构混乱）

*   仔细检查导出代码的完整性和正确性

![](img/82ed4b0228dc2a9c2642e0d4306671b3.png)
...
*   即使不打算上传到GitHub，也建议使用Git进行本地版本控制，预防Cursor可能导致代码改的面目全非

*   关键时间点的代码提交建议：

新功能实现后，Bug修复完成后，确认代码运行正常时

*   Git的安装和使用可以咨询Claude或ChatGPT

项目结构管理

1.  目录组织，一个总目录，下面放前端目录，后端目录，后面部署还有些别的文件

1.  使用Cursor进行开发

*   打开代码所在文件夹

*   使用@codebase命令让Cursor理解整个项目

![](img/73ee70629b2fda5098392420f8ee64f4.png)
...
*   启动后端服务（通常在localhost:8000）

*   通过FastAPI的交互式文档（localhost:8000/docs）测试接口：
...
![](img/1089ea9aa0de721e7b68e29a843fc473.png)

![](img/9e5ee5003c98ab1cafde52e92a2fbf65.png)
...
![](img/08d332a831ebec01a54bace45c35d61a.png)

启动前端，一般在localhost:3000这个地址访问

![](img/5a77972d378f0a113aceba5223571fb5.png)
...
![](img/148b58c7fb50cb81e3e221893b08b200.png)

![](img/d4d03c569d7a67349b873a243a2b159d.png)
