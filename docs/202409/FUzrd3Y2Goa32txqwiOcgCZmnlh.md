# 【AI写作】适合新手宝宝们入局的写作提示词指令（prompt）实操演示

> 来源：[https://lv9qj6hfr4z.feishu.cn/docx/FUzrd3Y2Goa32txqwiOcgCZmnlh](https://lv9qj6hfr4z.feishu.cn/docx/FUzrd3Y2Goa32txqwiOcgCZmnlh)
...
![](img/15f65a4b05ad6635e6bb09eb32069e56.png)

![](img/2c1a787572f006d70b12c830c0eb2521.png)

![](img/02bbae3e056ac6a607bb523538a73b5f.png)

![](img/98bfb576e9fade33ddce8423cf38482f.png)

得到结果：

![](img/fcb522b08934430fcfae2f3f023be3f6.png)

## AI爆文万能创作指令（情感家庭伦理故事）

![](img/a1f1bc31f3c87e5fc510d1882d855884.png)

![](img/0ac8271bbb02832f8c1a7edcc46d4cc5.png)
...
![](img/37a8b7d8f758d7a628d746ce49b4661e.png)
...
![](img/e64e04a816ebc6257d42eab43427c4d0.png)

![](img/22f34bb06f426f69f948069b65f099b4.png)
...
*   岁月如歌，教育梦中铸辉煌：这是一个抒情的标题，表达了作者对教育事业的深情和责任感。文章可能围绕作者的教育生涯展开，涉及个人经验和感悟。

1.  结构分析：

*   开头引入：描述作者在教学生涯中的使命与责任，通过乡村的景象渲染教育环境，奠定文章的情感基调。

*   主体部分：

*   乡村教育经历：描绘乡村学校的艰苦条件，以及乡村学生的求知欲望，强调教育对他们的意义。

*   城市教育经历：对比城乡的教育资源差异，体现作者的责任感和对教育方法的反思。

*   教育的变化与发展：文章提到时代的进步，国家政策的支持，使得教育条件改善，体现国家发展的进步。

*   结尾升华：从个人的教育梦到国家的教育发展，强调教育的伟大使命，并表达对未来教育事业的信心。

1.  段落逻辑：

*   时间线与空间转移：文章按照作者的职业经历，从乡村到城市，形成空间上的对比。同时，从新中国成立75年的时间维度，展示教育的变迁。

*   情感递进：通过细腻的描述，作者从教育的起点讲述，逐渐深化对教育的热爱和对社会责任的认识，情感逐步升华。

1.  主题挖掘：

*   教育的力量：文章反复强调教育在社会发展中的重要作用，特别是在乡村和城市学生中，教育如何改变了他们的命运。

*   时代的进步：通过乡村和城市的教育对比，展现了时代变迁对教育条件的改善，呼应“祖国从站起来、富起来到强起来”的伟大进程。

1.  语言与修辞：

*   抒情与叙事结合：文章充满诗意，如“晨曦初露，薄雾缭绕在乡间小路上”描绘了教育环境的美，营造出浓厚的情感氛围。

*   比喻与排比：多处运用了比喻和排比手法，使语言富有感染力，如“知识可以改变他们的未来”，“教育的力量如春风化雨”。

1.  总结分析：

*   这篇文章主要以作者的教育生涯为线索，通过个人经历折射出新中国成立75年来教育事业的变化和进步，表达了对未来教育事业的希望与信心。

![](img/2e1ba368e39467043dd509f55a0d5683.png)

### 提示词分析：

1.  主题导向性明确，但较为感性：

*   提示词的核心主题是“教育梦”和“时代变迁”，这些主题非常清晰且带有强烈的情感色彩。AI可以很好地理解并生成相关内容，但过于感性的提示词可能导致输出的文本过于抽象和情感化，而忽略了一些具体的细节。

1.  时间和空间线索明晰：

*   提示词提供了清晰的时间线（从新中国成立75年到现在）和空间转换（从乡村到城市）。这类结构对AI的写作逻辑非常友好，能够帮助AI更有条理地生成符合逻辑的叙事文本。

1.  缺乏细节引导：

*   提示词中虽然有一些场景的描述（如“乡村的稻田香气”“城市的教学环境优越”），但这些场景仍然较为抽象。AI可以生成类似的描述，但生成的内容可能会缺乏个性化的细节，导致输出趋于普遍化。

1.  引用过于宽泛：

*   文章中提到习近平总书记的文化思想和教育思想，但提示词并未给出具体的引文或背景。AI在生成这类内容时可能会模糊化处理，导致生成的文本缺乏针对性和深度。

### 优化建议：

1.  增强具象化描述：

*   为了帮助AI生成更丰富的细节，可以通过提示词明确指引某些具体的场景或事件。例如：

*   乡村教学场景可以提示：描述学生们如何在破旧的教室里上课，他们对知识的渴望如何表现，如何克服物质条件的不足。

*   城市教学场景可以提示：具体描写现代化的教学设备，学生们的学习方式有哪些不同之处，教师如何在城市学校应对竞争与压力。

1.  优化提示词示例：

*   乡村教学场景：乡村学校破旧的教室里，孩子们坐在斑驳的木桌前，目光炯炯，渴望从老师的每一句话中汲取知识。学生们如何在寒冷的冬天，用手捂着书本，学习写字。

*   城市教学场景：城市里，学生们坐在明亮的多媒体教室，屏幕上的知识点通过电子书籍传递给每个学生。他们如何利用互联网资源，结合老师的讲解，提升自我能力。

1.  分段指引，帮助AI理解段落结构：

*   在提示词中加入明确的段落结构提示，帮助AI更好地理解文章的逻辑关系。例如，指出每个段落的侧重点：如第一段侧重抒情，第二段开始转入具体的教学经历，第三段侧重城乡对比，最后一段回归总结和升华。

1.  优化提示词示例：

*   段落结构引导：

*   开头：以乡村晨曦中的教育场景开篇，抒发情感，描绘乡村教育的美景，表达作者的责任感。

*   中段：详细讲述在乡村和城市的教学对比，突出物质条件与学生学习状态的不同。

*   结尾：总结75年新中国的发展与教育的进步，表达对未来的信心。

1.  提供具体引文和理论支撑：

*   对于提到的习总书记文化思想，可以提供更具体的引文或背景，以确保AI能够生成具有针对性的内容。提示词可以要求AI引用某些著名的言论或政策文件。

1.  优化提示词示例：

*   文化思想引用：在提到习近平总书记的文化思想时，引用“文化自信是一个国家、一个民族发展中最基本、最深沉、最持久的力量”，并结合教育在培养文化自信方面的作用展开分析。

1.  引导AI处理情感与事实的平衡：

*   在提示词中，增加一些客观的、与情感并重的指引，帮助AI平衡情感表达和事实描述。例如，可以增加对乡村教育政策改善的具体数字或事件。

1.  优化提示词示例：

*   政策改善细节：加入国家对乡村教育的政策支持，如“从2010年起，国家逐步推进教育均衡发展，改善乡村学校基础设施，投入数百亿资金翻新校舍，购置教学设备。”
...
![](img/dff6584aed98a306e8c502557e9ba255.png)

![](img/a68be3d48e02cee5efda622f183ea795.png)
...
![](img/e86ec16dce413f1c41096da14809416b.png)
...
1.  创新产品与服务（如网上银行、新一代手机）

1.  科技对分销渠道的改变（如网络书店、机票、拍卖）
...
*   创新鞋款（如Lunar Haze+，Nike Air Max 2011，Nike Zoom Superfly）
...
![](img/886282f5745ac6c1d568bf177d5ffd46.png)

把文献按4个一组发给KIMI，提示词：每个文档各写一段，300字，按作者+（年份）+观点的形式

像这样

![](img/670ffcf954fa4b9a419c34b6550b8813.png)
...
![](img/b5668b1f9406406aaf4b82354eb25f8f.png)
...
![](img/28f9cdeb1e2192960b274fce05928507.png)
...
![](img/8e9ff182eb9381b0757d6d4b2d7175cb.png)
