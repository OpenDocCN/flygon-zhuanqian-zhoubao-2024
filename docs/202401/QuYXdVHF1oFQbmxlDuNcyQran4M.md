...
> 来源：[https://txt6wm3b04b.feishu.cn/docx/QuYXdVHF1oFQbmxlDuNcyQran4M](https://txt6wm3b04b.feishu.cn/docx/QuYXdVHF1oFQbmxlDuNcyQran4M)

## 1、我是越越

这是我的收益情况之一：

![](img/eae1b83baaf5682fe04a4bfde7f8b662.png)
...
1.  账号流量忽高忽低，就好比昨天起飞，今天就暴跌。

1.  账号因为流量大同行举报删文，还时刻担心收益被扣除。

1.  账号私信出现大量投诉、辱骂等信息，心态崩溃。
...
1.  找对标，抄对标。看到10W+就上，抄标题、抄素材！不加思考！

1.  纯用Ai创作，浪费时间。全依靠Ai创作，大多数时间都花在了指令调教上，效果并不理想。
...
1.  每天整理航海群里船员提出的问题，哪怕是自己已经解决的问题。

1.  针对这些问题对照自己的实际情况进行调整或者预防。

1.  结合平台规范进行进行延展学习。

![](img/67b8e63fbdac5cad98f95d2fa897c993.png)

我在某一天整理了10个相关的问题，其中有4个问题我自己没遇到过，那么我就会在笔记本上单独记录这4个问题的起因与发生症候以及可能产生的后果，总结大家的处理方法。当如果有一天出现了症候我就可以进行针对预防处理。

*   开窍：任何技术都不要与平台进行对抗，而是顺应平台。
...
1.  急于直接上手做项目。连基本的平台规则都不熟悉就直接做，动不动就违规。

1.  很多新手不重视平台规则。大多数人认为平台规则都是文邹邹的内容，没兴趣去阅读。

1.  人云亦云、盲目跟风。虽然说别人的经验可以参考，要学会甄别经验的优劣，少数被验证的经验不代表可靠。

1.  不明白自己做爆文的定位。自己做爆文适合做长期（精品）还是短期（批量）都不知道，摇摆不定！
...
1.  我的资源是自己整理的经验合集+精品素材库+官方创作指引

1.  我的发力点是Ai+手搓（融入人的情绪）

1.  我的困难是如何打造与其他人形成差异化和护城河

1.  我的原则是不跟风、不盲目、保持自己的节奏
...
1.  平台、读者、用户三个角色都有情绪。就像哄小媳妇一样，哄开心了，满足了他们的情绪，钱自然就有。

1.  人性不断变化，情绪可以被控制。结合指定人群，提前设置某一事件可能导致的情绪，并提前去布局。

1.  情绪通过文字、图片等内容被传递。文字图片等媒介可以传递情绪，读者有情绪里就会点击标题进行阅读。
...
1.  你清楚读者、用户、平台都喜欢什么样的文章？

1.  你清楚为什么其他人会来洗稿、抄袭、搬运？
...
1.  阅读量高的文章可能是存在数据偶然误差，需要结合其他互动数据进行分析。
...
1.  举棋不定，没有明确、固定、垂直的定位。

1.  自乱阵脚，一定周期内没有得到期望中的收益便随意更新。
...
*   作者——通过选择分发文章，消化平台广告投放需求而获取收益。

*   读者——通过阅读文章而感知社会发展变化，满足情绪价值。

*   平台——通过展示文章中的广告，以消化广告商的广告投放，从而获取广告费用。
...
1.  综合完读率：用户在文章100%位置中跳出的人数与总阅读人数的比例。

完读率越高，对应的广告单价越高。

而影响完读率的因素有很多。根据我的经验，以下几点措施可以提升完读率：

1.  增加文首、文末互动引导，指的是点赞、转发、在看等引导。

1.  增加标题与正文内容的相关性，而不是单纯使用震撼的标题忽悠读者点击阅读。

1.  增加文章的段落分割数。多用短句、口语化的语言，避免使用文邹邹的字词。

1.  突出文章重点，使用异色的字体标注段落重点。
...
1.  获取信息：读者可以通过阅读这篇文章获取到一些新鲜、有趣、实用的信息。

1.  满足情绪：读者通过文章中的措辞感受到情绪的变化，比如产生情绪共鸣、满足好奇心等。

1.  传递情绪：读者通过点击互动组件（点赞、分享、在看、星标等）进行文章传递，读者认可这篇文章并愿意把这篇文章传递给他人阅读，从而产生满足感。

以上三点重点均是满足“读者情绪”，因此读者的真正的需求关键词就是“满足情绪”，我们需要思考：

1.  读者分别在什么时候需要什么样的情绪呢？

1.  读者什么情况下才会主动去传递他的情绪呢？
...
1.  阅读广告：读者在阅读文章同时系统会随着阅读进度展现相应广告，一般底部广告收益比文中广告收益要高。

1.  点击广告：读者在阅读广告的同时点击广告贴片，产生“点击收益”。

1.  购买产品：读者在阅读广告后产生购买欲望，平台从而获取产品佣金。
...
1.  从大家普遍默认的观点对立面出发，激发读者“反抗情绪”。

我们为什么要设置“对立观点”？“对立观点”的好处有以下几点：

1.  提高读者的反抗情绪：读者通过点击文章发泄反抗情绪。

1.  提高文章的互动数据：读者有了反抗情绪后会进行留言或者私信，甚至转发等操作。

1.  提高文章在数据库中的差异化：大多数对立观点是同行人不敢写，因为数据飙升快、易被举报。
...
1.  情感共鸣多用“！、？”标点，也就是多用设问句、反问句。

1.  情感共鸣需要多站在读者的立场分析事件的始末。

1.  情感共鸣需要多使用“情绪表达”的词语，例如“你怎么想？你怎么看？我也觉得。。。。”
...
1.  满足读者的信息传递需求：获取新知是读者最爱的东西，满足这点需求可以提高文章质量。

1.  满足读者的获取新知的“自豪”情绪：读者一旦获取到所谓的新知，多半会产生自豪感，触发文章互动机制。

1.  满足平台扩充差异化、优质、原创文章的需求：普遍来看差异化、优质、原创文章是平台目前最需要的。
...
1.  人是感性的动物，喜欢家长里短：“家长里短”反映了人生百态，最能满足读者情绪的素材。

1.  人是知憎恨的动物，喜欢匡扶正义：对一些不道德的人或者事件会进行谴责。

1.  人是会同情、会怜悯的动物：也就是对某些人或者事件产生怜悯之心。

1.  人是被好奇心驱使的动物：新鲜少见的新闻人们往往最感兴趣。
...
1.  善用短句：单句使用20字以内的表达更容易让读者减少阅读疲劳和理解难度。

1.  段落合理：每段的句数不超过6句，可以减少文章的段落数。

1.  重点明确：使用划线功能、字体加粗标注重点，简单明了。

1.  思路清晰：文章框架清晰，前因后果清晰罗列。

除了文字部分，美观还包括图片美观、插件美观等，重点说说图片美观的应该具备的特点：

1.  图片清晰：不建议采用分辨率较低的图片。

1.  图片无明显侵权特征：无明显明星人物、商品Logo等可能导致侵权的元素出现。

1.  图文相符：图片与文字部分要有对照，而不是毫无相关。

1.  图片带有深韵：图片中表达的内容最好能够引发读者深思和联想。
...
1.  传递知识：符合规范下传递某些领域的专业知识，例医护养生、商业金融、读书认知等高价值、正能量的文章。

1.  分享经验：符合规范的前提下分享实操经验、避坑指南等真诚、利他的经验。

1.  展示个人观点：平台鼓励分享有见地、有深度的个人观点，从热点事件进行深入分析且是友好的交流。
...
1.  金融领域：证券、黄金、期货、P2P、贷款等。

1.  教育领域：K12、学科教育、未成年人教育等。

1.  医疗卫生领域：医疗器械、中药养生等。

1.  司法领域：社会影响力大的未结案案件分析、涉及敏感人物的案件分析等。
...
1.  看标题是否有点击的欲望，单纯的标题可以进行收藏，摒弃劣质的正文。

1.  看文章内容是否能够满足读者需求。如果能够激发读者情绪波动，则可作为素材备用。

1.  看文章的互动数据。优先考虑互动数据优秀的文章。如果单纯是阅读量高、互动数据差不推荐。
...
1.  标题带有情绪。其实就是满足读者的情绪需求，根据目标粉丝的需求进行设置。

1.  标题带有神秘感。为了满足读者对信息摄取的需求，充满神秘感的信息是首选。

1.  标题符合平台规范。符合平台规范是首要前提，尤其是相关事实类文章。

1.  标题使用数字形成强烈对比。通过数字放大对比效果，形成强烈的落差感。

1.  标题包含情绪标点符号。“！、？”等标点是情绪标点，通过使用设问、反问、陈述等方式。
...
1.  震惊！许家印交代被抓是因为犯了权贵大忌！卸磨杀驴这招玩得好
...
1.  标题新颖。无法在互联网中搜索到两个或者多个相似标题。

1.  内容观点独特。既能激发用户情绪，又能维护素材唯一性。

1.  避免随意确定对标。确定对标就要分析该对标的前世今生。

1.  避免暴露文章（账号）。运营过程中需要保护好相关信息，避免被同行对标。