# 12月RPA航海结束前，我用UiBot做出了一个美食地图探测机

> 来源：[https://sxv52sy063.feishu.cn/docx/XZSNd18lloG4Fgx8rQpc9blHntg](https://sxv52sy063.feishu.cn/docx/XZSNd18lloG4Fgx8rQpc9blHntg)
...
![](img/a5952f9663c0927001912d2dd023be21.png)

![](img/afab21052302b3e41bfa8bb3bdfa881c.png)
...
*   手动完成大众点评的账号登陆： 点击直达大众点评首页 👉 大众点评首页

*   手动完成讯飞星火的账号登陆：点击直达讯飞星火首页👉 讯飞星火首页

### 2.1.3、运行表格参数填写

*   在设计运行机器人前，先需要有一张数据表，后续机器人配置过程中，将会读取和存储表格数据，点击下载表格 →

*   需要自行填写参数表的两个参数：目标城市，给AI的好评分析提示词 （表格中给出了我的示例）

*   如果需要删除数据表中已存在的数据内容，请选择 【删除数据】操作，而不是【清除数据】操作
...
![](img/d1277e20f718d36ef32263ccc5bdb8ec.png)
...
![](img/fa96921d85bd2844701b7d7ea6859e15.png)

打开表格

![](img/7247d3c964542b6a5a2cf56e8e47a228.png)

启动浏览器并打开网页：

![](img/62e74ec26c5766ad83ad99b700d1e73f.png)

![](img/ba7141036bebddf3a527f3b914b62992.png)
...
![](img/e292baa9eea7968f517a65b41d4ff792.png)

①读取参数表中的内容，并准备放入到页面搜索框中

![](img/612922699a4284c4cd745700f33f8e72.png)

![](img/411d8254ebb65a636fd343b9e4be04d2.png)

![](img/4e55cd18bb964e99b8a3e1dbb8aaf14e.png)

②三个模拟按键模块完成【搜索目标城市】并确认，进入城市首页功能

![](img/fd2a4790d3fd6775546ac972a036d9df.png)

![](img/a6c9719e22354cd1dab39019e8563538.png)

![](img/e54a1380ea892e44b7ec9182b3b78939.png)

![](img/223519816182e07f0db0466a1a43ba7a.png)

![](img/ca5c90fe697ff1a06470cd5e979ce192.png)

③点击美食标签，进入城市美食页，点击人气，得到人气列表

（不涉及元素特征值的编辑，直接点击目标元素，按下图选择好目标元素即可）

![](img/cdbd194a4d43f2ab95d627c0138be865.png)

![](img/ad013f7bdd0165e0f66615d458f98710.png)

④用UiBot的数据抓取功能抓取页面想要的数据，按下图的顺序选择抓取即可

![](img/dd81b5eec61680a3f4a34f4080b53fd0.png)

![](img/31f2a1bafa97c0c163c6efb20114c81b.png)
...
![](img/f33b614cb6b43be0f1f3c79b40eee8c6.png)

![](img/d811e5181b2d60d42238e946a5c7213e.png)

![](img/ba63404000af2fcf761292f933d5f1db.png)

![](img/098d268a84afd8f172877fb3ea074ea7.png)

成功得到城市人气美食商家的表格数据：

![](img/f0365430d5b135d7636c5f9adbc9327e.png)

### 2.4.3、抓取各商家的评分和单项评分

模块每行说明如下：

![](img/4bb54a2504e83d79c002d96f4669204f.png)

①循环获取每个商家的评分、各项评分，这里初始值和结束值即排名第1到第10的商家，可按需修改

![](img/4c1071378c9a4485c2b1489edeb94fe0.png)

②读取【人气排行表】中的评价链接，并打开链接页面

![](img/dd3dc67d012fca62890bcf515aac7d6c.png)

![](img/644ed22d54a85426dafcd69ef65ace20.png)

![](img/28cf0141dba907da5b2952101cf9b52e.png)

③进入页面底部，点击 【更多评价】 元素，进入新的页面

![](img/bca99405e98659d3bbe5e988b24b888f.png)

![](img/dc28040255b9780cf3313484392e7ea2.png)

![](img/b331eebed92278903b29b3a2e7a29acb.png)

![](img/1836136662a809789cbdbadd3656fc09.png)
...
![](img/7c8156c10013865ac8ed6cab4776093a.png)

![](img/26193ad819d9ef53383f27240d5e60cd.png)

![](img/8ee713cba74198a1fca554d873e7c99f.png)

![](img/c9b93540675dd220d6e3abc99eab474d.png)

⑤写入人气排行表中

![](img/5e719071bbe2d0e760959b27d4fa1c37.png)

![](img/eeddeacae52c0366ebf8c98d93087818.png)
...
![](img/d376eb27f77275a228f85daee5ebca61.png)

①筛选好评，进入商家好评列表

![](img/2550a10daf73d56a32e8f13674cf8055.png)

![](img/15a234d1aa55b91211cec76951e13001.png)

②循环点击 展开评价元素

![](img/a2c37a96f815a14233dc0ab84949bf3d.png)

![](img/906ab08d82ee62dbf4438fd1f52658f2.png)

这里为什么要点击 展开评价 ？为什么还要循环？为什么要用尝试执行模块？为什么要跳出循环？

*   因为不展开评价，获取的每条评价内容只有少部分，不是完整的内容，所以需要展开;

*   因为每个页面默认都是展示15条评价，所以最多可能有15个【展开评价】按钮，从0到14正好是15个，在编写元素特征值时，用到了变量i，就是从0开始的，所以这里有这个循环操作；

*   因为乍一看，觉得每个商家一页都展示15条评价，是不是就一定会都有15个 【展开评价】 按钮，其实并不是，但某条评价内容本身很少的时候，就没有【展开评价】。
...
![](img/f7b2fb0cf90ac51cb29142c64db4f700.png)
...
![](img/e8b8eece29363103194d27da079a9143.png)

![](img/bed6263b03f6461d9d0565aa394e2f40.png)

至此，我们得到了如下数据：

![](img/9bd095562b9a75dda83df3449613f1f2.png)

⑤关闭标签页面

![](img/0a340c9398dfbd7c13624c0369e457cd.png)

因为循环打开各商家页，会导致网页很多，每次取完数据，关闭相应网页，可以节约系统资源。

至此，一次循环的操作就全部完成了。

### 2.4.5、通过AI分析好评内容，写出总结

模块每行说明如下：

![](img/2b08df1059fc1d506922eccd7ff6b167.png)

①打开讯飞星火主页：

![](img/7046964579c11e6cfef0c90a4272d7b7.png)

![](img/6f88bd7858bdb4da2b8de0ad64bda176.png)

②读取参数表中的指令：

![](img/b18e51c52a754b15c72760cf3f8d0b5a.png)

![](img/31bbc6c2af9f4e7d678b836fc6693b8e.png)

③读取所有好评内容，并与前面参数表的指令拼接，得到完整指令

![](img/372e46e9a6d2ad629903e45976feae5c.png)

![](img/a0d7920c2e25984ec0c3d4fda3357b6c.png)

![](img/540f558c135df61821591280f435ca01.png)

![](img/ae7e50d7d8ea287e168c0fac3de9720e.png)

④在讯飞星火页面新建对话，并将指令粘贴进对话框，发送提示语

![](img/3a4c4372f5886dc0973ceb7c1974dcbe.png)
...
![](img/5f35d297f400bd87aa448a7d71dcf8b5.png)

⑤判断内容是否生成完毕

![](img/a8ff6179c66829aa5cf0fa11bb3f7f1d.png)

![](img/7771ecf1e90932d7513dec72d4b3adc9.png)

生成内容完毕后，有此按钮，循环判断有此按钮即可

⑥获取生成的内容

![](img/dbddaa45e0c3415f10f814554c1be687.png)

![](img/07d13363c25ac53ab2fa63a275b3ef0f.png)

这里没有点击那个复制按钮，而是直接用的获取生成内容框中 的文本内容。因为操作中发现，用复制按钮的方式 粘贴进表格中后，生成内容中的emoji表情失效，而后一种方式保存成功，所以用了此方式。

⑦将内容写入表格

![](img/444af165e638df7999f94353a0187fed.png)

![](img/44e1e5f84503146bbf5ab83439b59dd6.png)
...
## 4.1、新人关于RPA学习的常见问题思考

这些问题是@Leeka 教练根据她在几个航海群的观察总结，给到我的，我就按我的理解简单分享，希望给RPA新人一点启发。

*   航海手册内容实在是太丰富了，静不下心来逐字逐句看完，看到别人的进度比自己快，心急如焚，怎么办？
...
*   很多时候，大家复刻的机器人就差一点点，结果就天差地别了，这个怎么破？
...
*   似乎大家都会在同一个坑里翻车，如何做能避免类似的情况发生？别人的经验如何能给我们自己赋能？
...
*   航海手册只提供了5个基础的机器人，然后就是大型机器人的分享了，在复刻的时候，我们要如何思考，如何举一反三呢？
...
*   从基础机器人到大型机器人，难度指数一下子暴涨，大家都吃不消了，这个要怎么破？
...
*   生财有术12月RPA航海手册👉 生财RPA航海手册 保姆级教程带你RPA入门

*   UiBot 官方命令手册 👉Uibot命令手册 Ps:前面说的单个模块测试和原理，在这里都能找到答案

*   UiBot开发者指南 👉UiBot开发者指南 对每个模块有详细文字介绍

*   RPA学习视频 👉RPA学习视频 应该是来也出的官方教程

*   开发者讨论社区👉 开发者社区 也许你遇到的问题里面就有

*   AI辅助提问 👉百度文心一言 不知道模块的运行逻辑，试着切到代码模式，把相应代码段输入到AI对话中，它会为你讲解，我一般用的文心一言，如果有魔法，用ChatGPT应该更好
